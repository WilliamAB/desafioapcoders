...
/**
 * Serviço de manutenção dos dados de {@link TipoDespesaEntity}.
 * 
...
public interface TipoDespesaService {
	 ...
	 */
	TipoDespesaEntity save(TipoDespesaEntity entity);
	 ...
	 */
	TipoDespesaEntity findByCodigo(Long codigo);
	 ...
	 */
	Page<TipoDespesaEntity> findByPage(int page, int limit);
